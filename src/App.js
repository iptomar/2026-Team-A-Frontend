  ...
  return <div className="App">
      <nav className="navbar app-navbar">
        <div className="app-navbar__brand">
          ...
          {(user.role === 'professor' || user.role === 'aluno') && <div className="nav-links">
          ...
          {(user.role === 'admin' || user.role === 'coordenador' || user.role === 'diretor') && <div className="nav-links">
              {user.role === 'admin' && <>
...
function App() {
  return <Router>
      <Routes>
        ...
        <Route path="/professor" element={<ProtectedRoute roleRequired="professor">
            <Layout><EcraProfessor /></Layout>
          </ProtectedRoute>} />
        <Route path="/aluno" element={<ProtectedRoute roleRequired="aluno">
            <Layout><EcraProfessor /></Layout>
          </ProtectedRoute>} />
        <Route path="/meus-pedidos" element={<ProtectedRoute roleRequired={['professor', 'aluno']}>
            <Layout><OsMeusPedidos /></Layout>
          </ProtectedRoute>} />
        <Route path="/detalhes-pedido/:id" element={<ProtectedRoute roleRequired={['professor', 'aluno', 'admin', 'coordenador', 'diretor']}>
        ...
        <Route path="/criar-formulario" element={<ProtectedRoute roleRequired="admin">
            <Layout><CriarFormulario /></Layout>
          </ProtectedRoute>} />
        <Route path="/editar-formulario/:id" element={<ProtectedRoute roleRequired="admin">
            <Layout><EditarFormulario /></Layout>
          </ProtectedRoute>} />
        <Route path="/gerir-pedidos" element={<ProtectedRoute roleRequired={['admin', 'coordenador', 'diretor']}>
            <Layout><GerirPedidos /></Layout>
          </ProtectedRoute>} />
        <Route path="/gerir-salas" element={<ProtectedRoute roleRequired="admin">
            <Layout><GerirSalas /></Layout>
          </ProtectedRoute>} />

        <Route path="/coordenador" element={<ProtectedRoute roleRequired={['admin', 'coordenador', 'diretor']}>
